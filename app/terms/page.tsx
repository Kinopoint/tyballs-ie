...
export default function TermsPage() {
  return (
    <main className="legal-page shell" id="main-content">
      ...
      <article>
        <h2>1. About this website</h2><p>TYBalls.ie is operated by DebsGuru Ltd from {site.address.slice(1).join(", ")}. It provides information and an enquiry route for Transition Year ball planning.</p>
