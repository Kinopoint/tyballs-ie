  ...
  return (
    <main id="main-content">
      ...
      <section className="editorial-page shell">
        <div className="editorial-intro"><p className="eyebrow">Pricing factors</p><h2>How we prepare a proposal</h2><p>DebsGuru does not publish a fixed TY Ball price because venue and supplier costs change. The committee receives relevant pricing after the main event details are known.</p></div>
      ...
      <section className="page-cta shell"><div><p className="eyebrow">Request pricing</p><h2>Request a proposal</h2></div><Link className="button button-dark" href="/enquire">Open the enquiry form</Link></section>
    </main>
  );
}
