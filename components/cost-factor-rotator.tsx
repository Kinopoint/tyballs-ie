    ...
    <div className="cost-rotator">
      <div className="cost-rotator-cards" aria-live="polite">
        <AnimatePresence initial={false} mode="sync">
          <motion.div animate={{ opacity: 1, y: 0 }} className="cost-rotator-card is-active" exit={{ opacity: 0, y: -10 }} initial={{ opacity: 0, y: 12 }} key={cards[active][1]} transition={{ duration: 0.42, ease: [0.16, 1, 0.3, 1] }}>
