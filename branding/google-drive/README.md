# Client Google Drive media manifest

Source folder supplied by the client on 2026-08-03:
<https://drive.google.com/drive/folders/1mxb42F8KVXqRovD6DgPBx2mHh-O5MvQg>

The site uses optimised derivatives only. Source originals remain in Google Drive.

| Published asset | Drive source | Use |
| --- | --- | --- |
| `drive-arrival.*` | `IMG_0893.jpg` — `16xg3clUzUgg2Ew2zANLzkQ3dYEWafQG1` | friends / arrival |
| `drive-dinner.*` | `IMG_0960.jpg` — `1EoKlM0w55_8n4dcPH5vd3_38Lt66hQ-z` | dinner and hospitality |
